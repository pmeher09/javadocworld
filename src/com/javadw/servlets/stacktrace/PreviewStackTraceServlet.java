...
@WebServlet("/previewStackTrace")
public class PreviewStackTraceServlet extends HttpServlet {

	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
			throws ServletException, IOException {
		String path = "stackTracePreview.jsp";
		String message = "";
		...
		if (session != null) {
			...
			if (JdwUtil.isValidLogin(email_id)) {
				...
				StackTrace questionAnswers = new StackTrace();
...
//					answer= answer.replace(">", "&gt;");
				...
				StackTrace questionAnswersPreview = new StackTrace();
