		...
		<div id="site-content">
			...
			<div id="content-right">
				<div id="sub-content-left">
					...
					<form action="saveStackTrace" method="post">
						<div style="border: solid 1px #00ff40; padding: 2px; ">
						<div id="div-question-answer" >
						
							<div id="div-question"><c:out value="${tricky_question_answer_preview.question}" escapeXml="false" /> 
							<div id="div-answer">	<c:out value="${tricky_question_answer_preview.questionCode}" escapeXml="false" /></div>
							</div>
							Answer:
							<hr>	
							<div id="div-answer"><c:out value="${tricky_question_answer_preview.answer}" escapeXml="false" /> </div>
						</div>
					</div>
