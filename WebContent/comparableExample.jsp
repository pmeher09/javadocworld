...
<html>
<head>
<title>Comparable Example in Java</title>
<link rel="shortcut icon" type="image/x-icon"
	href="images/title_icon.png" />
<meta http-equiv="content-type" content="text/html; charset=utf-8">
<meta name="description" content="Java Comparable Example" />
<meta name="keywords"
	content="Comparable implementaion, java,compairable example, compairable program, write a compairable interface">
		...
		<div id="site-content">
			...
			<div id="content-right">
				<div id="sub-content-left">
						...
						<h1>Comparable Example in Java</h1></div>
...
class Student implements Comparable&lt;Student&gt; {
	...
	public int compareTo(Student stud) {
		<span id="div-code-comment">// TODO Auto-generated method stub</span>
...
public class ComparableExample {
	...
	public static void main(String args[]) {
		...
		<span id="div-code-comment">// Here it Sorts the arrayList using comparable</span>
