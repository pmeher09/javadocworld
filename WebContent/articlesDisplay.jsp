...
<link href="${pageContext.request.contextPath}/css/articles/style.css"
	rel="stylesheet" type="text/css">
<script async
	src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<!-- Go to www.addthis.com/dashboard to customize your tools -->
<script type="text/javascript"
	src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-561d2c227d4b482e"></script>
<script>
					...
					<div id="interview_qn_ans">
						...
						<div id="core-java">
							<div id="div-question-answer">
								...
								<h1>
									<c:out value="${st.question}" escapeXml="false" />
								</h1>
								...
								<div id="div-question-user">
									<span
										style="color: #fff; background-color: #5fba7d; padding: 2px 6px 2px 6px;"><c:out
											value="${st.category}" escapeXml="false" /></span> &nbsp;&nbsp; <span
										style="color: #333; background-color: #eff0f1; padding: 2px;"><c:out
											value="${st.displayDate}" escapeXml="false" /></span>
											<div style="float: right;" id="div-question-user">
								<i>Posted by <span  style="color: #666;  padding: 2px;">  
											<b><c:out value="${st.submittedBy}" escapeXml="false" /></b></span> </i> 
									&nbsp;&nbsp;
								</div>
								</div>
