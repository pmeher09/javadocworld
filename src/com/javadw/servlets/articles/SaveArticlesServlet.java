...
@WebServlet("/saveArticles")
public class SaveArticlesServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		if (session != null && saveAction != null) {
			...
			if (JdwUtil.isValidLogin(email_id)) {
				Articles questionAnswers = (Articles) session
				...
				if (questionAnswers != null) {
					...
					articlesBo.save(questionAnswers);
