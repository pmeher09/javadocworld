...
<html>
<head>
<title>J2EE Interview Questions and Answers</title>
				...
				<div id="sub-content-left">
					...
					<div id="interview_qn_ans">
						...
						<div style="margin-left: 80px; margin-bottom: 30px;">
							<h2>Top Tricky J2EE interview questions and Answers</h2>
						</div>
					<form action="saveJ2EEQuestions" method="post">
						<div style="border: solid 1px #00ff40; padding: 2px; ">
						<div id="div-question-answer" >
							<div id="div-question">Q.1) <c:out value="${j2ee_question_answer.question}" escapeXml="false" /> </div>
							<div id="div-answer"><c:out value="${j2ee_question_answer.answer}" escapeXml="false" /> </div>
						</div>
					</div>
